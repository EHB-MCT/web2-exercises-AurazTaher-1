...
function createVenueInfo(venue, hours){
    ...
    let rating = createRating(venue)
    let addToMyListButton = createMyListButton(venue,hours)
    container.appendChild(rating)
    container.appendChild(addToMyListButton)
...
function createRating(){
    ...
    input.placeholder = "geef deze plaats een rating"
    input.type = "number"
